export function generateVerificationOtpEmailTemplate(otpCode) {
    ...
    <footer style = "margin-top: 20px ; test-align: center ; font-size: 14px ; color: #666>
    <p> Thank You, <br> BookWorm  Team </p>
    <p style = "font-size: 12px ; color : #444 ; ">This is an automatedm message. Please do not reply to this email. </p>
    </footer>
    </div>`;
}
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
    ...
    <p style = "font-size: 16px ; color: #ccc;">If the buttom doest not work , copy and paste the following url into your browser. </p>
    <p style = "font-size: 16px ; color: #fff; word-wrap :"> ${resetPasswordUrl}</p>
    <footer style = "margin-top: 20px ; test-align: center ; font-size: 14px ; color: #666>
    <p> Thank You, <br> BookWorm  Team </p>
