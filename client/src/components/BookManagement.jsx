...
const BookManagement = () => {
  ...
  /* ---------- FIX 1: get auth data from state.auth (not state.book) ---------- */
  ...
  return (
    <>
      <main className="relative flex-1 p-1 pt-28">
        <Header />
        <header className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center">
          ...
          <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
            ...
            <input
              ...
              className="w-full sm:w-52 border-52 border p-2 border-gray-300 rounded-md"
              ...
              <tbody>
                {searchedBooks.map((book, index) => (
                  ...
                  >
                    ...
                    {/* ---------- FIX 2: backticks for price string ---------- */}
