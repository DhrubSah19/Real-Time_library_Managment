      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
        ...
        <header className="flex justify-between items-center mb-7 pb-5 border-b-[1px] border-black">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-bolf">Change Credentials</h3>
          </div>
        ...
        <form onSubmit={handleUpdatePassword}>
          ...
          <div className="mb-4 sm:flex gap-4 items-center">
            <label className="block text-gray-900 font-medium">Enter Current Password</label>
    
            <input type = "password" value = {currentPassword} onChange={ (e) => setCurrentPassword(e.target.value)} placeholder="Current Password" className="w-full px-4 py-2 border-gray-300 rounded-md "></input>
          </div>
    
            <div className="mb-4">
            <label className="block text-gray-900 font-medium">Enter New Password</label>
    
            <input type = "password" value = {newPassword} onChange={ (e) => setNewPassword(e.target.value)} placeholder="Enter new password" className="w-full px-4 py-2 border-gray-300 rounded-md "></input>
          </div>
    
            <div className="mb-4">
            <label className="block text-gray-900 font-medium">Confirm New Password</label>
    
            <input type = "password" value = {confirmNewPassword} onChange={ (e) => setConfirmNewPassword(e.target.value)} placeholder="Enter Confirm New Password" className="w-full px-4 py-2 border-gray-300 rounded-md "></input>
          </div>
