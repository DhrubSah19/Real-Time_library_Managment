...
const ResetPassword = () => {
  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div className="text-center h-[450px]">
          ...
          <h3 className="text-gray-300 mb-12 max-w-[320px] mx-auto text-3xl font-medium leading-10">"Your premier digital library for borrowing and reading"</h3>
    </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleResetPassword}>
            <div className="mb-4 ">
                 <input type = "password" value = {password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" required className="w-full px-4 py-3 border-black rounded-md focus:outline-none"/>

                <input type = "password" value = {confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm Password" required className="w-full px-4 py-3 border-black rounded-md focus:outline-none"/>
