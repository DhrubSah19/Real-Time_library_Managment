...
const Register = () => {
  ...
  const{user , error , loading , message , isAuthenticated} = useSelector((state) => state.auth);
  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div className="w-full max-w-sm">
      <div className="flex justify-center mb-12">
        <div className="flex justify-center-reverse sm:flex-row items-center justify-center gap-5">
      ...
      <form onSubmit={handleRegister}>
        ...
        <div className ="block md:hidden font-semibold mt-5">
          <p>Already have an Account ?
            <Link to ="/login" className="text-sm text-gray-500 hover:underline"></Link>
          </p>
